...
URL = 'http://127.0.0.1:8098/index.html?v=t_d28f2a9b'
SHOT = Path('/root/autonauts-orchestrator-prototype/t_d28f2a9b-tool-visuals-local.png')

with sync_playwright() as p:
    browser = p.chromium.launch(headless=True)
    page = browser.new_page(viewport={"width": 900, "height": 420, "device_scale_factor": 1})
    errors = []
    ...
    result = page.evaluate("""async () => {
      ...
      return { changed, items: items.length };
    }""")
...
print(f'tool visuals smoke passed: {SHOT}')
