import { BUILDING_TYPES, PROGRAMS, PROGRAM_TEMPLATES, ALLOWED_OPS, DEFAULT_WORLD_ZONES } from './data.js?v=grove_anim_cache_0705';
import { CAMPAIGN_MAP_FEATURES, CAMPAIGN_MAP_SIZE, CAMPAIGN_START, CAMPAIGN_DIALOGUES, getCampaignArrivalScene } from './campaign-scenes.js?v=grove_anim_cache_0705';
import { createCanvas2dRenderer } from './renderers/canvas2d-renderer.js?v=grove_anim_cache_0705';
import { createRenderState } from './render-state.js?v=grove_anim_cache_0705';
import { installCombatSystem, IDLE_BOT_AUTO_ATTACK_RANGE, PLAYER_AUTO_ENGAGE_RANGE } from './systems/combat/combat-system.js?v=grove_anim_cache_0705';
import { BOW_ATTACK, DEFENSE_TOWER_ATTACK, MELEE_AUTO_ATTACK, MONSTER_MELEE_ATTACK } from './systems/combat/combat-config.js?v=grove_anim_cache_0705';
import { installTaughtLoopSystem } from './systems/dsl/taught-loop-system.js?v=grove_anim_cache_0705';
import { installCodeLoopSystem } from './systems/code-loop/code-loop-system.js?v=grove_anim_cache_0705';
import { installInventorySystem } from './systems/inventory/inventory-system.js?v=grove_anim_cache_0705';
import { assemblerRecipe as getAssemblerRecipe, DEFAULT_SMITHERY_RECIPE, DEFAULT_WORKBENCH_RECIPE, installProductionSystem, productionInputCount, productionInputNeeds as getProductionInputNeeds, SMITHERY_RECIPES, smitheryInputFor, smitheryRecipe, WORKBENCH_TOOL_RECIPES, workbenchRecipe } from './systems/production/production-system.js?v=grove_anim_cache_0705';
import { FOG_CELL_SIZE, createFogOfWar, fogRevealSources as createFogRevealSources, getFogStats, isLightEmittingStructure as isFogLightEmittingStructure, normalizeFogOfWar, revealFogCircle, serializeFogOfWar, structureLightRadius as fogStructureLightRadius, updateFogOfWarState } from './fog-of-war.js?v=grove_anim_cache_0705';
import { clamp, rand, distXY, nearest, pointInRect, rectDistance, canvasPoint, escapeHtml } from './utils.js?v=grove_anim_cache_0705';
import { installCameraSystem } from './systems/camera-system.js?v=grove_anim_cache_0705';
import { installPlayerSystem } from './systems/player-system.js?v=grove_anim_cache_0705';
import { installMonsterSystem } from './systems/monster-system.js?v=grove_anim_cache_0705';
import { installStructureSystem } from './systems/structure-system.js?v=grove_anim_cache_0705';
import { installBotSystem } from './systems/bot-system.js?v=grove_anim_cache_0705';
import { installTeachSystem } from './systems/teach-system.js?v=grove_anim_cache_0705';
import { installSpawnSystem } from './systems/spawn-system.js?v=grove_anim_cache_0705';
import { installInteractionSystem } from './systems/interaction-system.js?v=grove_anim_cache_0705';
import { installHealthSystem } from './systems/health-system.js?v=grove_anim_cache_0705';
import { installDialogueSystem } from './systems/dialogue-system.js?v=grove_anim_cache_0705';
