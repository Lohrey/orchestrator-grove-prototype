import { createCanvas2dRenderer } from './canvas2d-renderer.js?v=grove_full_cache_0705';
...
export async function createRenderBackend({ canvas, mode = 'pixi', capture = false, settings = null } = {}) {
  ...
  if (normalized === 'pixi') {
    try {
      const { createPixiRenderer } = await import('./pixi-renderer.js?v=grove_full_cache_0705');
