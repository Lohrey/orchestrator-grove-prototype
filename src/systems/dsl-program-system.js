// src/systems/dsl-program-system.js
// DSL program resolution, validation, and bot assignment:
// getBotProgram, resolveStepSlots, normalizeUseHeldItemDslStep,
// validateDslProgram, assignCustomDslProgram, assignBotProgram.
// Part of the Game class composition root — installed via installDslProgramSystem(Game, deps).
//
// This system is part of the binding Action Step Mechanism Chain (see root AGENTS.md).
// Any change to validateDslProgram or the assignment methods must keep the chain
// synchronized (world.js execution, action-steps.js registry, data.js templates,
// assistant knowledge packs, teach-by-doing, UI, and tests).
//
// Dependencies (passed via deps):
//   ALLOWED_OPS, DEFAULT_FOLLOW_DISTANCE, DEFAULT_MANAGER_KNOWLEDGE_PACKS,
//   DEFAULT_NEARBY_RADIUS, DEFAULT_RESOURCE_RADIUS, ITEM_TYPES, MAX_NEARBY_RADIUS,
//   PROGRAMS, PROGRAM_TEMPLATES, buildingKitItemTypeFor, clamp, clone, itemLabel.

export function installDslProgramSystem(Game, deps) {
  const {
    ALLOWED_OPS,
